...
namespace program.optimal
{
    public class CSProject : TextProject
    {
        ...
        {
            base._setId(@"zyouhua@gmail.com:cspro4ject");
            base._firstInit();
        }
        ...
        public void _showPropertyDockWidget()
        {
            ...
            workbenchSingleton_._showContent(this);
        }
        ...
        public CSProject()
        {
            mProjectDockWidget = new CSProjectDockWidget();
            base._regDockWidget(mProjectDockWidget);
        }

        CSProjectDockWidget mProjectDockWidget;
    }
}
