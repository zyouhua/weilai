...
{
    public class CProject : TextProject
    {
        ...
        {
            base._setId(@"zyouhua@gmail.com:cproject");
            base._firstInit();
        }
        ...
        public override void _treeNodeRightClick(TreeNodeMouseClickEventParams nTreeNodeMouseClickEventParams)
        {
            ...
            string contextMenuStripUrl_ = @"rid://program.optimal.cprojectNodeContextMenuStripUrl";
        ...
        protected override string _fileSuffix()
        {
            return @"cproject";
        }

        static readonly string mCProjectImageUrl = "rid://program.optimal.cprojectImageUrl";
        public override string _getTreeNodeImage()
        {
            return mCProjectImageUrl;
        }
