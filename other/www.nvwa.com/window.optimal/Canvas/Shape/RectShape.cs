...
namespace window.optimal
{
    ...
    {
        public bool _rectInMoving()
        {
            return mLabelShape._inMoving();
        }

        public void _rectOffset(Point2I nPoint)
        {
            mRect._offset(nPoint);
        }

        public void _rectAdjustPoint()
        {
            mRect._adjustPoint();
        }
        ...
        public virtual Point2I _rectAdjustJoinPoint(Point2I nBeg, Point2I nEnd)
        {
            Rect2I rect_ = mLabelShape._rectGetRect2I(mIndex);
            Point2I result_ = rect_._connectPoint(nEnd);
            return result_;
        ...
        public void _initRect(IRect nRect)
        {
            ...
            mRect = nRect;
            mRect.m_tInMoving += this._rectInMoving;
            mRect.m_tGetRect2I += this._getRect2I;
            mRect.m_tAdjustJoinPoint += this._rectAdjustJoinPoint;
        }
